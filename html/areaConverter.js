...
function areaConverter(source, valNum) {
    ...
    if (source === "sqFeet") {
        ...
        sarsaiInput.value = (valNum * acreKanal * kanalMarla * sarsaiMarla).toFixed(2);
        ...
        sarsaiInput.value = (valNum * kanalMarla * sarsaiMarla).toFixed(2);
